...
playlist = []
music_folder = "C:/Users/almas/Desktop/Laba1-main/Jupyter nigga/music"
...
pygame.display.set_caption("Japanese")
clock = pygame.time.Clock()
background = pygame.image.load(os.path.join("element", "background.webp"))
bg = pygame.Surface((500, 200))
bg.fill((255, 255, 255))
font2 = pygame.font.SysFont(None, 20)

playb = pygame.image.load(os.path.join("element", "play.png"))
pausb = pygame.image.load(os.path.join("element", "pause.webp"))
nextb = pygame.image.load(os.path.join("element", "next.png"))
prevb = pygame.image.load(os.path.join("element", "back.png"))
index = 0
aplay = False
